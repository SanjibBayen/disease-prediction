...
class PredictionResponse(BaseModel):
    ...
    timestamp: str = Field(default_factory=lambda:  datetime.now(ist).strftime("%Y-%m-%d %H:%M:%S"), description="Prediction timestamp")
...
class HealthResponse(BaseModel):
    ...
    timestamp: str = Field(default_factory=lambda:  datetime.now(ist).strftime("%Y-%m-%d %H:%M:%S"), description="Response timestamp")
...
class ErrorResponse(BaseModel):
    ...
    timestamp: str = Field(default_factory=lambda:  datetime.now(ist).strftime("%Y-%m-%d %H:%M:%S"), description="Error timestamp")
